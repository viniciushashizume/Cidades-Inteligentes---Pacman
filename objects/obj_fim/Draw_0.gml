hover_menu = (mouse_x > btn_menu_x && mouse_x < btn_menu_x + btn_largura &&
              mouse_y > btn_menu_y && mouse_y < btn_menu_y + btn_altura);

hover_sair = (mouse_x > btn_sair_x && mouse_x < btn_sair_x + btn_largura &&
...
draw_text(room_width / 2, 100, "Parabens!");
draw_text(room_width / 2, 150, "Voce reciclou todos os fios!");
